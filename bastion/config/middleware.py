# -*- coding: utf-8 -*-
"""WSGI middleware initialization for the bastion application."""
from repoze.who.config import make_middleware_with_config as make_who_with_config

from bastion.config.app_cfg import base_config
from bastion.config.environment import load_environment
